...
rem set "CATALINA_PID=%CATALINA_HOME%\bin\catalina.pid"
...
rem set JAVA_OPTS=%JAVA_OPTS% -Djavax.sql.DataSource.Factory=org.apache.tomcat.dbcp.dbcp2.BasicDataSourceFactory
